...
export function GameModelBlack(props) {
  const { nodes, materials } = useGLTF('/game-model-black.glb')
  return (
        ...
        <group rotation={[-Math.PI / 2, 0, 0]}>
          <group rotation={[0, 0, 1.13]}>
            <group position={[10.28, -558.81, 38.41]}>
              <group position={[0.06, -132.06, 0]}>
                <group rotation={[Math.PI / 2, 0, 0]}>
                  <group position={[-9.02, 0, -2]}>
                    <mesh geometry={nodes.Rectangle030.geometry} material={materials['15 - CoronaMtl']} />
                  </group>
                </group>
              </group>
              <group position={[0.06, 132.03, 0]}>
                <group rotation={[Math.PI / 2, 0, Math.PI]}>
                  <group rotation={[-Math.PI, 0, 0]} scale={[-1, 1, 1]}>
                    <group position={[-9.02, 0, -2]}>
                      <mesh geometry={nodes.Rectangle032.geometry} material={materials['15 - CoronaMtl']} />
                    </group>
                  </group>
                </group>
              </group>
              <mesh geometry={nodes.Box031.geometry} material={materials['15 - CoronaMtl']} position={[0.06, -0.02, -297.5]} />
              <mesh geometry={nodes.Box032.geometry} material={materials['красная полоса']} position={[-205.2, -0.02, -317.5]} />
              <mesh geometry={nodes.Box033.geometry} material={materials['красная полоса']} position={[203.89, -0.02, -317.5]} />
              ...
              <mesh geometry={nodes.Rectangle029.geometry} material={materials['красная полоса']} position={[0.06, -120.09, 0]} rotation={[Math.PI / 2, 0, 0]} />
              <mesh geometry={nodes.Rectangle031.geometry} material={materials['красная полоса']} position={[0.06, 120.05, 0]} rotation={[-Math.PI / 2, 0, -Math.PI]} scale={[-1, 1, 1]} />
            </group>
                ...
                <group position={[0, 0, 91.21]}>
                  ...
                  <group position={[-1.78, 0, -310.99]}>
                    <group position={[0, 0, -15.68]}>
                      <mesh geometry={nodes.Box028.geometry} material={materials['красный  метал']} />
                    </group>
                  </group>
                  <group position={[-1.78, 0, 30.56]}>
                    <group position={[0, 0, -335.5]}>
                      <mesh geometry={nodes.Box030.geometry} material={materials['черный метал']} />
                    </group>
                  </group>
            ...
            <group position={[8.15, 560.06, -323.23]}>
              <group position={[0, 0, -15.68]}>
                <mesh geometry={nodes.Box037.geometry} material={materials['красный  метал']} />
              </group>
            </group>
            <group position={[8.15, 560.06, 18.32]}>
              <group position={[0, 0, -335.5]}>
                <mesh geometry={nodes.Box039.geometry} material={materials['черный метал']} />
              </group>
            </group>
              ...
              <group position={[41.77, 0, 53.57]}>
                <group scale={1.11}>
                  <group position={[0, 0, -1.17]}>
                    <mesh geometry={nodes.Box045.geometry} material={materials['черный метал']} />
                  </group>
                </group>
              </group>
              <group position={[2.37, 0, -5.1]}>
                <group rotation={[Math.PI / 2, 0, 0]}>
                  <group position={[-7.81, -8.79, -20.81]}>
                    <mesh geometry={nodes.Cylinder041.geometry} material={materials['черный метал']} />
                  </group>
                </group>
              </group>
              <group position={[39.79, 0, 41.56]}>
                <group position={[0, -0.3, -13.85]}>
                  <mesh geometry={nodes.Cylinder042.geometry} material={materials['черный метал']} />
                </group>
              </group>
              <group position={[-47.76, 0.8, -8.74]}>
                <group rotation={[Math.PI / 2, 0, 0]}>
                  <group position={[1.8, -3.85, -15.01]}>
                    <mesh geometry={nodes.Line040.geometry} material={materials['черный метал']} />
                  </group>
                </group>
              </group>
            </group>
            <group position={[-285.65, -379.72, -322.88]}>
              <group position={[41.77, 0, 53.57]}>
                <group scale={1.11}>
                  <group position={[0, 0, -1.17]}>
                    <mesh geometry={nodes.Box046.geometry} material={materials['черный метал']} />
                  </group>
                </group>
              </group>
              <group position={[2.37, 0, -5.1]}>
                <group rotation={[Math.PI / 2, 0, 0]}>
                  <group position={[-7.81, -8.79, -20.81]}>
                    <mesh geometry={nodes.Cylinder043.geometry} material={materials['черный метал']} />
                  </group>
                </group>
              </group>
              <group position={[39.79, 0, 41.56]}>
                <group position={[0, -0.3, -13.85]}>
                  <mesh geometry={nodes.Cylinder044.geometry} material={materials['черный метал']} />
                </group>
              </group>
              <group position={[-47.76, 0.8, -8.74]}>
                <group rotation={[Math.PI / 2, 0, 0]}>
                  <group position={[1.8, -3.85, -15.01]}>
                    <mesh geometry={nodes.Line041.geometry} material={materials['черный метал']} />
                  </group>
                </group>
              </group>
            </group>
            <group position={[321.41, -379.46, -322.88]} rotation={[0, 0, -Math.PI]}>
              <group position={[41.77, 0, 53.57]}>
                <group scale={1.11}>
                  <group position={[0, 0, -1.17]}>
                    <mesh geometry={nodes.Box047.geometry} material={materials['черный метал']} />
                  </group>
                </group>
              </group>
              <group position={[2.37, 0, -5.1]}>
                <group rotation={[Math.PI / 2, 0, 0]}>
                  <group position={[-7.81, -8.79, -20.81]}>
                    <mesh geometry={nodes.Cylinder045.geometry} material={materials['черный метал']} />
                  </group>
                </group>
              </group>
              <group position={[39.79, 0, 41.56]}>
                <group position={[0, -0.3, -13.85]}>
                  <mesh geometry={nodes.Cylinder046.geometry} material={materials['черный метал']} />
                </group>
              </group>
              <group position={[-47.76, 0.8, -8.74]}>
                <group rotation={[Math.PI / 2, 0, 0]}>
                  <group position={[1.8, -3.85, -15.01]}>
                    <mesh geometry={nodes.Line042.geometry} material={materials['черный метал']} />
                  </group>
                </group>
              </group>
            </group>
            <group position={[321.41, 559.21, -322.88]} rotation={[0, 0, -Math.PI]}>
              <group position={[41.77, 0, 53.57]}>
                <group scale={1.11}>
                  <group position={[0, 0, -1.17]}>
                    <mesh geometry={nodes.Box048.geometry} material={materials['черный метал']} />
                  </group>
                </group>
              </group>
              <group position={[2.37, 0, -5.1]}>
                <group rotation={[Math.PI / 2, 0, 0]}>
                  <group position={[-7.81, -8.79, -20.81]}>
                    <mesh geometry={nodes.Cylinder047.geometry} material={materials['черный метал']} />
                  </group>
                </group>
              </group>
              <group position={[39.79, 0, 41.56]}>
                <group position={[0, -0.3, -13.85]}>
                  <mesh geometry={nodes.Cylinder048.geometry} material={materials['черный метал']} />
                </group>
              </group>
              <group position={[-47.76, 0.8, -8.74]}>
                <group rotation={[Math.PI / 2, 0, 0]}>
                  <group position={[1.8, -3.85, -15.01]}>
                    <mesh geometry={nodes.Line043.geometry} material={materials['черный метал']} />
                  </group>
                </group>
              </group>
            </group>
            ...
            <mesh geometry={nodes.Object010.geometry} material={materials['красная полоса']} position={[-291.09, 579.72, -336.77]} rotation={[Math.PI / 2, 0, 0]} />
            <mesh geometry={nodes.Object011.geometry} material={materials['красная полоса']} position={[-291.09, -358.91, -336.77]} rotation={[Math.PI / 2, 0, 0]} />
            <mesh geometry={nodes.Object012.geometry} material={materials['красная полоса']} position={[326.85, -400.27, -336.77]} rotation={[-Math.PI / 2, 0, -Math.PI]} />
            <mesh geometry={nodes.Object013.geometry} material={materials['красная полоса']} position={[326.85, 538.4, -336.77]} rotation={[-Math.PI / 2, 0, -Math.PI]} />
          </group>
        </group>
      </group>
    </group>
...
useGLTF.preload('/game-model-black.glb')
